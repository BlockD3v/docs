...
Users may both **buy and sell** tokens. Fees apply only on sell transactions and scale with 24-hour volume. Graduation occurs when real ETH, BNB on the curve reaches **6.9 ETH / 13 BNB**.
...
- All remaining tokens and ETH/BNB are deposited as liquidity.
