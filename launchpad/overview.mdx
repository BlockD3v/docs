...
<CardGroup cols={2}>
  <Card title="Pre-Bond" icon="lock" href="/launchpad/fair-launch#phase-1-pre-bond">
    ...
    Note: if your token fails to get to Bonding Stage, after 24-hour timeline contract will automatically send back you your Native Token(ETH or BNB) on the same address as you bought
  </Card>
